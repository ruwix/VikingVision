...
public class BetterCamera2Renderer extends BetterCameraGLRendererBase {
    ...
    protected void openCamera(int id) {
        ...
        final CameraManager manager = (CameraManager) mView.getContext().getSystemService(Context.CAMERA_SERVICE);
        try {
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ...
            final CameraManager manager = (CameraManager) mView.getContext().getSystemService(Context.CAMERA_SERVICE);
            try{manager.setTorchMode(cameraDevice.getId(), true);}
            catch(Exception e){Log.i(LOGTAG, e.getLocalizedMessage());}
        }
